...
document.getElementById("searchBtn").onload = function() {
  search();
};

function search() {
  var requestString =
    "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/search?number=1&offset=0&type=main%20course&limitLicense=true&query=";
